...
R12941077: 本次期末專題開發結合 LINE Bot 與網頁的記帳工具，在 AI 的協助下，程式碼編寫與編譯的負擔減輕許多，讓我能將更多心力轉向思考產品設計，探討什麼樣的功能、回饋感與使用性才是使用者真正需要的。不過我也深刻體會到「下 Prompt」的深奧，與 AI 協作時經常發生「要修 A 卻導致 B 出錯」的邏輯衝突，需要極高的精確度。此外，外部服務的 API 支援度也是開發的一大難題，原先預想整合的手機載具及 LINE 錢包功能，皆因未公開 API 而無法實作，導致使用者無法享受全自動化的便利，操作上被迫稍微多了一個步驟，這也成為本次專案在理想與現實妥協下的一大重要反思。
