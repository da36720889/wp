...
B11705055:這次期末專案是製作一個 LINE 記帳機器人。整個專案做下來，我覺得現在有 AI 輔助之後，技術上的問題其實沒有想像中那麼困難，很多功能或錯誤只要查資料或問 AI，大多都能找到解法。相較之下，反而是 UI 和 UX 的設計花了我最多時間。像是要怎麼讓使用者記帳記得順、指令不會太複雜、回覆訊息看起來清楚好懂，這些都沒有標準答案，只能一直調整和嘗試。這次專案讓我發現，寫出能跑的程式不難，但要做出真正好用、讓人願意使用的系統，其實需要花很多時間去思考使用者的角度。
